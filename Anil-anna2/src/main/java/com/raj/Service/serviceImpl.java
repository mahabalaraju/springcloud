...
import com.raj.exception.NoproductFoundException;
import com.raj.exception.ResouceNotFoundException;
import com.raj.exception.productnotfoundException;
...
public class serviceImpl implements productService {
	...
	public String updateProduct(product product) {
		...
		if (newproduct.isPresent()) {
			...
			throw new NoproductFoundException("No product found with given id:" + product.getId());
	}
	...
	public List<product> getlistofproductsbyname(String name) {
		...
		if(productlist!=null) 
			...
			throw new productnotfoundException("no found with the given name");
	}
}
